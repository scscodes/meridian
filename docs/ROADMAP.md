...
- **Chat NL-First Refactor** — `@meridian` routes all NL via LLM classifier (`DELEGATE_CLASSIFIER_PROMPT`), 14 LM tools for Copilot agent mode, `RESULT_FORMATTERS` map for extensible output, full command parity via chat.
